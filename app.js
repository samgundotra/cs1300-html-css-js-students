...
const updatePage = async () => {
  ...
  let highSugar = fruitsArray.filter(function (e) {
    return e.nutritions.sugar > 15;
});
  console.log(highSugar);

  // TODO: Create a new HTML element to display your data
  const newElement = document.createElement('div');
  const existingElement = document.getElementById('cs1300-gallery');

  let highSugarFruits = highSugar.map(function (e) {
    const newElement = document.createElement('div');
    newElement.innerHTML = e.name;
